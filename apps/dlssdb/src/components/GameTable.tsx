...
import type { DlssGame, HltbInfo, SteamInfo, MetacriticInfo, UpscalingInfo, SortCol, Filters } from "../types";
...
export const COLUMNS: Column[] = [
  ...
  new DlaaColumn(),
  new DlssVersionColumn({ showByDefault: "tablet" }),
  new FrameGenColumn({ showByDefault: "mobile" }),
  new UpscalingColumn(),
  new MetacriticColumn({ showByDefault: "desktop" }),
  new HltbColumn({ showByDefault: "tablet" }),
  new ReleaseDateColumn(),
  new RrColumn(),
  new RtColumn({ showByDefault: "desktop" }),
  new SrColumn(),
