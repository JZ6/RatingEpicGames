/**
 * Shared utilities for Rating Epic Games update scripts.
 *
 * Provides file I/O, game name extraction from game_data.json,
...
/** Unified data file — all sources (steam, hltb, metacritic, epic) keyed by game name. */
...
/** Extract all game names from game_data.json. */
export function getGameNames() {
  return Object.keys(loadJson(GAME_DATA_FILE));
}
